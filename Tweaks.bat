...
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\Memory Management" /v "DisableDynamicBoost" /t REG_DWORD /d "1" /f
...
REM 380000,000f4240/1000000/4000000
