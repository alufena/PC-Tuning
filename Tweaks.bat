...
REM 0000000a/00000000/0000003c
...
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\GraphicsDrivers\Configuration\GSM60B216843009_01_07DC_0E^3D9A69AD1C84EAB2AAF1FC3855733BB4" /v "Scaling" /t REG_DWORD /d "2" /f
